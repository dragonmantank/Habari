...
?>
    ...
    <div class="comments">
     <h4><span id="comments"><?php echo $post->comments->approved->count; ?> Responses to <?php echo $post->title; ?></span></h4>
     <div class="metalinks">
      <span class="commentsrsslink"><a href="<?php URL::get( 'entry', "slug={$post->slug}" ) ?>">Feed for this Entry</a></span> <span class="trackbacklink">Trackback Address</span>
     </div>
...
?>
      ...
      <li id="comment-<?php echo $comment->id; ?>" class="comment">
       ...
       <small class="comment-meta"><a href="#comment-<?php echo $comment->id; ?>" title="Time of this comment"><?php echo $comment->date; ?></a></small>
