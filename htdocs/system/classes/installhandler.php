 ...
 * Child classes will invoke specific methods for installation for each
 * server type
 */
abstract class InstallHandler extends ActionHandler
{
	...
	public function act_begin_install()
	{
		...
		*/
        ...
        /**
         * Returns an instance of the InstallHandler that is appropriate
         * for the server
         * @param string $server Server string ($_SERVER['SERVER_SOFTWARE'])
	...
	*/
	...
	/**
         * attempts to write the rewrite config if none exists
         * or to write the Habari-specific portions to an existing rewrite config
         * @param bool whether a rewrite config file already exists or not
	 * @param bool whether to remove and re-create any existing Habari block
         * @param bool whether to try a rewritebase in the rewrite config
	**/
